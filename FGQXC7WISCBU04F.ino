...
float Res_Value = 9.1;  // Resistor Value in Ohm
float Vcc = 4.98; // Voltage of Arduino 5V pin ( Mesured by Multimeter )
...
float Bat_High = 1.5; // Battery High Voltage
float Bat_Low = 0.9; // Discharge Cut Off Voltage
